      ...
      <div className="my-7 py-6 w-full flex flex-col  justify-between">
        ...
        <div className="mx-auto w-96  bg-white flex items-center  rounded-lg drop-shadow-md md:shadow-sm">
          ...
          <div className=" md:p-2 mr-2">
            <button className="rounded-full focus:outline-none w-14 h-9 md:w-14 md:h-9 flex items-center justify-center" onClick={onSubmit}>
            <svg width="24" height="24" fill="none" aria-hidden="true" className=" mr-3 flex-none"><path d="m19 19-3.5-3.5" stroke="#c0c0c0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path><circle cx="11" cy="11" r="6" stroke="#c0c0c0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></circle></svg>
            </button>
          </div>
        </div>
